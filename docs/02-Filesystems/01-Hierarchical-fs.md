...
There are different types of filesystems, intended for different purposes. Most filesystems track metadata about a file in addition to the file name (usually written as "filename"), such as the date/time of creation, the date/time of last modification, the owner or original creator of the file, and the permissions applicable to the file (for example, who is permitted to read and to change the file contents).
