...
If the command or commands in LIST1 execute successfully and return an
exit status code of 0, then the commands in LIST2 are executed.

For example, you could use a *grep* command as LIST1 and an *echo*
command as LIST2:
